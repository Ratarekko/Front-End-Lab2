...
2. Переглянути онлайн:
   👉 [**Посилання на сторінку**](https://ratarekko.github.io/Front-End-Lab2/) 
...
git clone https://github.com/ratarekko/Front-End-Lab2
...
# Зробити коміт
git commit -m "Додано index.html та style.css"
